...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <div class="company-info">
                ...
                <div style="font-weight: bold; font-size:12px; color:#00207d">JL.PANTI SOSIAL KM.10 RT.024 RW.009 No.41
                </div>
                <div style="font-weight: bold; font-size:11px; color:#00207d">KEL.KEBUN BUNGA - KEC. SUKARAME - KOTA
                    PALEMBANG - SUMSEL 30152</div>
                <div style="font-size:8px; font-family: 'STXihei'; color:#00207d; font-weight: bold;">Phone/WA:
                    082278100852&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: Arbellalebaksejahtera@gmail.com
                </div>
            </div>
        </div>
        <div class="letterhead-line"></div>
        <h3 style="text-align: left; font-size: 12px; margin-top: 0; margin-bottom: 1px; color:#0070c0">Kepada Yth :
        </h3>
        ...
        <div class="info-container">
            <div class="info-left" style="font-weight: bold">
                ...
                <p style="font-size: 11px; margin: 5px 0;">Kilometer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                    {{ $estimation->workOrder->kilometer ?? '-' }}</p>
                <p style="font-size: 11px; margin: 5px 0;">
                    No.SPK&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
                    {{ $estimation->workOrder->no_spk ?? '-' }}</p>
                <p style="font-size: 11px; margin: 5px 0;">
                    Tanggal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                    {{ $estimation->created_at->format('d/m/Y') }}</p>
            </div>

            <div class="info-right" style="font-weight: bold">
                <p style="font-size: 11px; margin: 5px 0; color:#002060; ">ESTIMASI PERBAIKAN KENDARAAN</p>
                <p style="font-size: 11px; margin: 5px 0;">Type Kend.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
                    {{ $estimation->workOrder->type_kendaraan ?? '-' }}</p>
                <p style="font-size: 11px; margin: 5px 0;">Serv.Advisor&nbsp;&nbsp;&nbsp;&nbsp;:
                    {{ $estimation->workOrder->service_advisor }}</p>
                <p style="font-size: 11px; margin: 5px 0;">Cust name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                    {{ $estimation->workOrder->customer_name ?? '-' }}</p>
                <p style="font-size: 11px; margin: 5px 0;">
                    User&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                    {{ $estimation->workOrder->service_user }}</p>
            </div>
        </div>

        <div class="keluhan-section" style="font-weight: bold">
            <p style="font-size: 11px; margin: 5px 0;">KELUHAN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                {{ $estimation->workOrder->keluhan ?? '-' }}</p>
        </div>
            ...
            <tbody>
                @foreach ($estimation->estimationItems as $index => $item)
                    <tr>
                        ...
                        <td style="text-align: center; font-size:10px;">{{ $item->serviceRequest->quantity }}
                            {{ $item->serviceRequest->satuan }}</td>
                        <td style="text-align: right; font-size:10px;">{{ number_format($item->price, 0, ',', '.') }}
                        </td>
                        <td style="text-align: center; font-size:10px;">{{ $item->discount }}%</td>
                        <td style="text-align: right; font-size:11px;">{{ number_format($item->total, 0, ',', '.') }}
                        </td>
                    </tr>
                @endforeach
            </tbody>
        ...
        <div>
            <p style="font-size: 12px; font-style: italic; color:#0070c0">Harga penawaran diatas Exclude (diluar PPN dan
                PPH) <br>
            <p style="font-size: 12px; color:#0070c0 ">Demikian Estimasi ini kami sampaikan atas perhatian dan
    ...
    <div class="signature-section">
        <div class="signature-box">
            <p style="font-size: 12px; margin-bottom: 40px; color:#002060">Hormat Kami,</p>
            <br>
            <p style="font-size: 12px; margin-top: 5px; color:#002060; font-weight:bold">Arbella Lebak Sejahtera</p>
        </div>
