...
class ServiceRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            'sparepart_name' => 'required|exists:spareparts,name',
            ...
            'sparepart_name.exists' => 'Nama sparepart tidak ditemukan.',
        ]);

        $validatedData['user_id'] = auth()->id();


        $sparepart = \App\Models\spareparts::where('name', $request->sparepart_name)->first();
        $validatedData['sparepart_id'] = $sparepart ? $sparepart->id : null;
